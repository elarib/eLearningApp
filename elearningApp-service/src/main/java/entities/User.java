...
public class User implements Serializable {
	...
	public String toString() {
		return "User [Token="+token + ", userName=" +userName + ", prenom=" + prenom + ", nom=" + nom + ", motDePasse=" + motDePasse
				 + ", motDePasseConfirm=" + motDePasseConfirm + ", email=" + email+ ", dateNaissance=" + dateNaissance.toString()
				+ "]";
	}
